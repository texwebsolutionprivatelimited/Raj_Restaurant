...
export function CheckoutRazorpay() {
 ...
 const handlePayment = async () => {
  ...
  if (paymentMethod === 'cod') {
    ...
    router.push(
      `/order-success?orderId=${mockOrderId}`
    )
  ...
  if(items.length === 0) {
      return (
        <div className="min-h-screen bg-black pt-32 pb-12 px-4">        <div className="max-w-4xl mx-auto text-center text-gray-400">
    ...
    return (
      <div className="min-h-screen bg-black pt-32 pb-12 px-4">      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
        {/* Order Summary */}
            ...
            {paymentStatus === 'success' && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-green-400 text-sm">Redirecting to order confirmation...</p>
                </div>
              </motion.div>
            )}
