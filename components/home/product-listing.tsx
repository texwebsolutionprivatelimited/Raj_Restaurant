      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 mt-4 text-lg max-w-2xl mx-auto">
            Discover our chef’s special dishes crafted with authentic
          ...
          {products.map((item, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                {/* Veg/NonVeg Badge */}
                <span
                  className={`absolute top-4 left-4 px-3 py-1 rounded-full text-sm font-medium ${item.type === 'Veg'
              ...
              <div className="p-6">
                ...
                <p className="text-gray-400 mb-6">
                  Rich taste, authentic spices, and premium quality
