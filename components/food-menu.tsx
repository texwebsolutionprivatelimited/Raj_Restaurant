...
const menuItems: MenuItem[] = [
  {
    ...
    price: 450,
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1599599810694-cd881f6a3e6f?w=400&h=300&fit=crop',
...
export function FoodMenu() {
  ...
  const toggleFavorite = (itemId: number, e: React.MouseEvent) => {
    e.preventDefault()
    e.stopPropagation()
  }
    ...
    <section className="w-full py-16 px-4 md:px-8 bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-neutral-400 text-lg">Handpicked dishes crafted by our top chefs</p>
        </motion.div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-neutral-500">({Math.floor(Math.random() * 500) + 50})</span>
                  </div>
