    ...
    <>
      ...
      <div className="min-h-screen bg-black pt-32 pb-20 px-4">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-gray-400 text-lg text-center mb-8">Thank you for your order</p>
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-white">
                  Status:{" "}
                  <span className="text-green-600 font-bold">Preparing</span>
                </p>
                <p className="text-gray-400 text-sm mt-1">
            ...
            <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
              <p className="text-gray-400 text-sm">
                ...
                <span className="text-red-500 font-bold">+91-9999-999-999</span>{" "}
                or email{" "}
          ...
          <p className="text-gray-500 text-xs text-center mt-8">
            🔒 Your order information is secure and encrypted. We never share
...
export default function OrderSuccessPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-black pt-32 pb-12 px-4 text-center text-white">Loading Order Details...</div>}>
      <OrderSuccessContent />
    </Suspense>
  );
}
