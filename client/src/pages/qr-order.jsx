        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 mb-8 text-lg">
              You&apos;ve scanned the QR code successfully. Start ordering your
              favorite dishes now!
            </p>
            ...
            <div className="space-y-4 mb-8 text-left bg-gray-900/50 rounded-lg p-6 border border-gray-800">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Select from our wide variety of dishes
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Choose quantity and add items to your cart
                  </p>
                </div>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-700">
              <p className="text-gray-400 text-sm">
                Your table number ({tableId}) will help our staff identify your
                orders. Please have it ready for payment.
              </p>
            </div>
          </motion.div>
        </div>
...
export default function QROrderPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-black pt-32 pb-12 px-4 text-center text-white">Loading Order...</div>}>
      <QROrderContent />
    </Suspense>
  );
}
