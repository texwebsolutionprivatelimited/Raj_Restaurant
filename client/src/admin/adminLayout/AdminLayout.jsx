...
export default function AdminLayout() {
    ...
    const menuItems = [
        ...
        { path: "/admin/bookings", label: "Event Bookings", icon: Calendar },
        { path: "/admin/roombookings", label: "Room Bookings", icon: BookImageIcon },
    ...
    const handleLogout = () => {
        ...
        navigate("/login"); // ya "/" agar login home pe hai
    };
            ...
            >
                ...
                <nav className="space-y-2">
                    ...
                    <button
                        ...
                        className="w-full mt-6 flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-500/10 rounded-xl"
                    >
                        <LogOut size={18} />
                        Logout
                    </button>
